                  ...
                  <form action="<?php echo base_url().'ktu/save_kasek'?>" method="post" enctype="multipart/form-data">
				   ...
				   foreach($list_ta as $value)
				   {
                    ...
                    ?>
							...
							<input name="nm_kasek" class="form-control"  type="text" value="<?php echo $kasek->nm_kasek?>" required autofocus>
							</div>
							<div class="form-group col-md-6">
							<label for="nip_kasek">NIP KEPELA SEKOLAH</label>
							<input name="nip_kasek" class="form-control" type="text" value="<?php echo $kasek->nip_kasek?>" required autofocus>
							</div>
							</div>
