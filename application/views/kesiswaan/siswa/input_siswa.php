            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content table-responsive">
                	   <h4 class="title"> Form Input Data Siswa </h4>
		                    	
		                      <form action="<?php echo base_url().'kesiswaan/save_siswa'?>" method="post" enctype="multipart/form-data">
						  ...
						  <div class="form-group col-md-6">
							...
							<input name="nis" class="form-control"  type="number"  required autofocus>
							</div>
							<div class="form-group col-md-6">
							<label for="nisn">NISN</label>
							<input name="nisn" class="form-control" type="number" required autofocus>
							</div>
							</div>
							<div class="row">
							<div class="form-group col-md-6">
						   ...
						   foreach($list_kelamin as $value)
						   {
							...
							<input name="tgl_lahir" id="tgl_lahir" data-date-format="MM-DD-YYYY" class="form-control"  type="date" required autofocus>
							</div>
							</div>
							<div class="row">
							<div class="form-group col-md-6">
						   ...
						   foreach($list_kelas as $value)
						   {
		                    ...
		                    echo form_dropdown('kelas',$list,'',"class='form-control '");    
		                    ?>
							</div>
							<div class="form-group">
