            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content table-responsive">
		                      ...
		                      <form action="<?php echo base_url().'kesiswaan/update_siswa'?>" method="post" enctype="multipart/form-data">
						  ...
						  <div class="form-group col-md-6">
						   ...
						   foreach($list_kelamin as $value)
						   {
							...
							<input name="tgl_lahir" id="tgl_lahir" class="form-control" value="<?php echo $siswa->tgl_lahir?>" type="date" required autofocus>
							</div>
							</div>
							<div class="row">
							<div class="form-group col-md-6">
