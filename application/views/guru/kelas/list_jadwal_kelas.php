            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" data-background-color="orange">
                        <h4 class="title">Data Nilai Siswa <br><b>Mata Pelajaran <?php echo $pelajaran->nm_pelajaran?></b></h4>
                        ...
                        <table class="table table-responsive table-striped table-bordered " id="tabel" >
                            ...
                            foreach($list_nilai as $row)
                            {
                                ...
                                <tr>
                                    ...
                                    <td align="center"><?php echo $row->nilai_spritual?></td>
                                    <td align="center"><?php echo $row->nilai_sosial ?></td>
