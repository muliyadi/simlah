             ...
             <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content table-responsive">
                    	 <h4 class="title">Form Akun Guru </h4>
					<form action="<?php echo base_url().'guru/update_password'?>" method="post" enctype="multipart/form-data">
					...
					<input name="id_guru" class="form-control" readonly="true" placeholder="ID GURU" value="<?php echo $guru->userid?>" required autofocus>
					</div>
					<div class="form-group ">
					<label class="label">User Name</label>
					<input name="username" type="text" class="form-control" placeholder="Nama" required value="<?php echo $guru->username?>">
					</div>
					<div class="form-group">
