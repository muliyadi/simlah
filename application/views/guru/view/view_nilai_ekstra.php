            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" data-background-color="orange">
                        <h4 class="title"> Data Nilai Ekstra Kurikuler <br>Kelas <?php echo $kelas ?>Tahun Ajaran <?php echo $kd_ta?></h4>
					...
					Jumlah Siswa Dengan Nilai: 1).Sangat Baik= <?php echo $tot4?>, 2).Baik= <?php echo $tot3?> , 3).Cukup= <?php echo $tot2?> , 4).Kurang= <?php echo $tot1?> .
                    </div>
                </div>
            </div>
            </div>
