                        ...
                        <table class="table table-responsive table-striped table-bordered " id="tabel" >
                            ...
                            foreach($list as $row)
                            {
                                ...
                                <tr>
                                    ...
                                    <td align="center"><?php echo $row->nm_siswa.'/'.$row->nis?></td>
                                    <td><?php echo $row->nm_pelajaran.' /'.$row->gelar_depan.'.'.$row->nm_guru.','.$row->gelar_belakang?></td>
