<div class="content">
   ...
   <input type="text" value="<?php echo $kd_ta?>" name="kd_ta">
    <input type="text" value="<?php echo $program?>" name="program">
   DATA NILAI KELULUSAN SISWA
    ...
    foreach($sheet as $row){ 
      ...
      if($numrow > 1){
        ...
        $GEO_td = ( ! empty($GEO))? "" : " style='background: #E07171;'";
        $SJR_td = ( ! empty($SJR))? "" : " style='background: #E07171;'";
        
        $SOS_td = ( ! empty($SOS))? "" : " style='background: #E07171;'";
        $EKO_td = ( ! empty($EKO))? "" : " style='background: #E07171;'";
       ...
       <td<?php echo $GEO_td?> align='center'><?php echo $GEO?></td>
       <td<?php echo $SJR_td?> align='center'><?php echo $SJR?></td>
       <td<?php echo $SOS_td?> align='center'><?php echo $SOS?></td>
       <td<?php echo $EKO_td?> align='center'><?php echo $EKO?></td>
   ...
   Keterangan:<br>Upload dapat dilakukan jika tidak ada lagi cell(row x colum) berwarna merah';
    ...
    <?php
      ...
      echo "<a href='".base_url("kasek")."' class='btn btn-warning'>Cancel</a>";
    }
    ?>
    </form>;
