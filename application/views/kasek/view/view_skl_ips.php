<div class="content">
    ...
    foreach($list as $row){ 
      ...
      ?>
       ...
       <td align='center'><?php echo $row->SJR?></td>
       <td align='center'><?php echo $row->SOS?></td>
       <td align='center'><?php echo $row->EKO?></td>
       <td align='center'><?php echo $row->LTM1?></td>
       <td align='center'><?php echo $row->RATA2?></td>
       <td align='center'><?php echo $row->kelulusan?></td>
        <td align='center'><a href="<?php echo base_url('kasek/hapus_skl_ips').'/'.$row->nis.'/'.$kd_ta?>"  class="btn btn-danger btn-sm">Delete</a><a href="<?php echo base_url('kasek/skl_ips').'/'.$row->nis.'/'.$kd_ta?>"  class="btn btn-warning btn-sm">Print</a></td>
       </tr>
      <?php 
