        ...
        <div class="wrapper">
            <div class="sidebar" data-color="green" data-image="<?php echo base_url(); ?>assets/img/sidebar-1.jpg">
               <div class="logo text-center">
					...
					<?php echo $this->session->userdata('nm_user');?><br>Tahun Ajaran
					<?php echo $this->session->userdata('kd_ta');?>
                </div>
                <div class="sidebar-wrapper">
                    <ul class="nav">
                        <li class="">
                            <?php //echo anchor('welcome','<i class="material-icons"> Dashboard');?>
                            <a href="<?php echo base_url('kasek') ?>">
                        ...
                        <div class="collapse" id="data">
                            <ul class="nav">
                                 <li >
                            <a href="<?php echo base_url('kasek/sekolah')?>">
                                <i class="material-icons">foundation</i>
                                <p>Profil Sekolah</p>
                            </a>
                        </li>
                            <li>
                                <a href="<?php echo base_url('kasek/siswa')?>">
                                <i class="material-icons">school</i>
                                <p>Siswa</p>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url('kasek/guru')?>">
                                <i class="material-icons">hail</i>
                                <p>Guru</p>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url('kasek/matapelajaran')?>">
                       ...
                       <li class="default">
                        ...
                        <div class="collapse" id="transaksi">
                            <ul class="nav">
                               		 <li >
                            <a href="<?php echo base_url('kasek/upload_skl')?>">
                        ...
                        <a data-toggle="collapse" href="#monitoring">
                            ...
                            <p>Monitoring<b class="caret"></b></p>
                        </a>
                        <div class="collapse" id="monitoring">
                            <ul class="nav">
                               <li >
                            <a href="<?php echo base_url('kasek/jadwal')?>">
                                <i class="material-icons">list</i>
                                <p>Kontrol Nilai</p>
                            </a>
                        </li>
                        <li >
                            <a href="<?php echo base_url('kasek/usulan_akses_nilai')?>">
                                <i class="material-icons">list</i>
                                <p>Izin Akses Nilai</p>
                            </a>
                        </li>
                        <li >
                            <a href="<?php echo base_url('kasek/kalender_akademik')?>">
                                <i class="material-icons">list</i>
                        ...
                        <div class="collapse" id="laporan">
                            <ul class="nav">
                                <li>
                                    <a href="<?php echo base_url('kasek/flaporan_bulanan_siswa')?>">
                                    <i class="material-icons">list</i>
                                    <p>Pregress Bulanan</p>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url('kasek/nilai_rendah_siswa_guru')?>">
                                    <i class="material-icons">list</i>
                                    <p>Nilai Rendah</p>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url('kasek/frapor')?>">
                                    <i class="material-icons">list</i>
                                    <p>Rapor</p>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url('kasek/skl_lap')?>">
                                    <i class="material-icons">list</i>
                                    <p>SKL</p>
                                    </a>
                                </li>
