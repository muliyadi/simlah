        ...
        <div class="row">
             <div class="col-md-12">
                <div class="card">
					...
					<form action="<?php echo base_url().'wakasekkurikulum/save_thn_ajaran'?>" method="post" enctype="multipart/form-data">
					...
					<input name="tahun" class="form-control" type="number" required autofocus>
					</div>
					<div class="form-group">
				   ...
				   foreach($list_semester as $value)
				   {
                    ...
                    echo form_dropdown('semester',$list,'',"class='form-control id_desa'");    
                    ?>
					</div>
					<div class="form-group">
