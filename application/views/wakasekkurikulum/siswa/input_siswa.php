              ...
              <div class="card">
                ...
                <div class="card-body ">
                  ...
                  <ul class="nav nav-pills nav-pills-warning" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link btn" data-toggle="tab" href="#link4" role="tablist">
                        Pendidikan Sebelumnya
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link btn" data-toggle="tab" href="#link5" role="tablist">
                        Orang Tua / Wali
                      </a>
                    </li>
                  </ul>
                  ...
                  <div class="tab-content tab-space">
                    <div class="tab-pane active" id="link1">
		                      ...
		                      <form action="<?php echo base_url().'wakasekkurikulum/save_siswa'?>" method="post" enctype="multipart/form-data">
