        ...
        <div class="row">
             <div class="col-md-12">
                <div class="card">
					...
					<form action="<?php echo base_url().'wakasekkurikulum/save_mata_pelajaran'?>" method="post" enctype="multipart/form-data">
					...
					<input name="kd_pelajaran" class="form-control" required autofocus>
					</div>
					<div class="form-group">
					<label for="nm_relawan">Nama Mata Pelajaran </label>
					<input name="nm_pelajaran" class="form-control" autofocus required />
					</div>
					<div class="form-group">
				   ...
				   foreach($list_kategori as $value)
				   {
                    ...
                    echo form_dropdown('subkategori',$list,'',"class='form-control'");    
                    ?>
					</div>
