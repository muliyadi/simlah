        ...
        <div class="row">
             <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="<?php echo base_url().'wakasekkurikulum/save_jadwal'?>" method="post" enctype="multipart/form-data">
                   ...
                   foreach($list_kelas as $value)
                   {
                    ...
                    echo form_dropdown('kelas',$list,$kelas,"class='form-control id_desa'");    
                    ?>
                    </div>
                    <div class="form-group">
                   ...
                   foreach($list_hari as $value)
                   {
                    ...
                    echo form_dropdown('hari',$list,'',"class='form-control id_desa'");    
                    ?>
                    </div>
                    <div class="form-group">
                    <label for="tahun">Jam Masuk</label>
                    <input name="jam_masuk" class="form-control" type="time" required autofocus>
                    </div>
                    <div class="form-group">
                    <label for="tahun">Jam Keluar</label>
                    <input  name="jam_keluar" class="form-control" type="time" required autofocus>
                    </div>
                    <div class="form-group">
                   ...
                   foreach($list_pelajaran as $value)
                   {
                    ...
                    echo form_dropdown('kd_pelajaran',$list,'',"class='form-control id_desa'");    
                    ?>
                    </div>
                    <div class="form-group">
                   ...
                   foreach($list_guru as $value)
                   {
                    ...
                    echo form_dropdown('id_guru',$list,'',"class='form-control id_desa'");    
                    ?>
                    </div>
