             ...
             <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content table-responsive">
                    	<h4 class="title">Edit Registrasi Siswa </h4>
					<form action="<?php echo base_url().'wakasekkurikulum/save_registrasi_siswa'?>" method="post" enctype="multipart/form-data">
				   ...
				   {
					   $test=$value->nis.'-'.$value->nm_siswa;
					   $list[$value->nis]=$test;
					  
				   }
                    echo form_dropdown('nis',$list,$nisx,"class='form-control drop'");    
                    ?>
					</div>
				   ...
				   foreach($list_status as $value)
				   {
                    ...
                    echo form_dropdown('status',$list,'',"class='form-control drop'");    
                    ?>
					</div>
