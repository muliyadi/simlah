<div class="content">
             ...
             <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content table-responsive">
				          <h4 class="title">Form Import Nilai Kelas <?php echo $kelas ?></h4>
                        <p class="category">Mata Pelajaran <?php echo $pelajaran->nm_pelajaran?></p>
				        <form method="post" action="<?php echo base_url("wakasekkurikulum/import").'/'.$kd_jadwal; ?>" enctype="multipart/form-data">
                                <!-- 
  ...
  if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
    ...
    echo "<form method='post' action='".base_url("wakasekkurikulum/import2")."'>";
    ?>
    ...
    foreach($sheet as $row){ 
      ...
      if($nis == "" && $nilai_spritual == "" && $nama == "" && $kelas == "" && $nilai_spritual == "" && $nilai_sosial == "" && $nilai_pengetahuan == "" && $nilai_keterampilan == "" && $desc_nilai_pengetahuan == "" && $desc_nilai_keterampilan == "")
      ...
      if($numrow > 1){
        ...
        if($nis == "" or $nm_siswa == "" or $kelas == "" or $nilai_spritual==""){
    ...
    <?php
      ...
      echo "<a href='".base_url("wakasekkurikulum")."'>Cancel</a>";
    }
