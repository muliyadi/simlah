        ...
        <div class="row">
             <div class="col-md-12">
                <div class="card">
					...
					<form action="<?php echo base_url().'wakasekkurikulum/update_kkm'?>" method="post" enctype="multipart/form-data">
					...
					<label for="group_relawan">Tahun Ajaran</label>
						   ...
						   foreach($list_thn_ajaran as $value)
						   {
		                    ...
		                    echo form_dropdown('kd_ta',$list,$kkm->kd_ta,"class='form-control '");    
		                    ?>
					</div>
						<div class="form-group">
					<label for="group_relawan">Tingkat</label>
						   ...
						   foreach($list_tingkat as $value)
						   {
		                    ...
		                    echo form_dropdown('tingkat',$list,$kkm->tingkat,"class='form-control '");    
		                    ?>
					</div>
					<div class="form-group">
					<label for="program">Nilai</label>
					<input name="kkm" class="form-control" type="number" value="<?php echo $kkm->kkm?>" required autofocus>
					</div>
					...
					<label for="group_relawan">Status</label>
						   ...
						   foreach($list_status as $value)
						   {
		                    ...
		                    echo form_dropdown('status',$list,$kkm->status,"class='form-control '");    
		                    ?>
					</div>
