             ...
             <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content table-responsive">
                    	  <h4 class="title">Form Edit Kegiatan Akademik </h4>
					<form action="<?php echo base_url().'wakasekkurikulum/update_kegiatan'?>" method="post" enctype="multipart/form-data">
					...
					<label for="group_relawan">Kegiatan</label>
							<input type="text" name="kegiatan" value="<?php echo $kegiatan->kegiatan?>" autofocus="true" class="form-control">
					</div>
