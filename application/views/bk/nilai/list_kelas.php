            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                    	  <h4 class="title"> Form Input Nilai Ekstra Kurikuler </h4>
                       <form action="<?php echo base_url().'bk/input_nilai_ekstra'?>" method="post" enctype="multipart/form-data">
						   ...
						   foreach($list_kelas as $value)
						   {
							...
							<div class="form-group">
							<label for="group_relawan">Ekstra Kurikuler</label>
							 <input type="text" name="kd_ekstra"  id="kd_ekstra"   class="form-control" placeholder="Ketik Ekstra Kurikulier">
							
							</div>
							<button class="btn btn-info btn-sm">Lanjut</button>
