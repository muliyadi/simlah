                    ...
                    <div class="card-content ">
                        ...
                        <form action="<?php echo base_url().'siswa/update_siswa'?>" method="post" enctype="multipart/form-data">
						  ...
						  <div class="form-group col-md-6">
							...
							<input name="nisn" class="form-control" type="number" value="<?php echo $siswa->nisn?>" readonly="true"  autofocus>
							</div>
							</div>
							<div class="row">
							<div class="form-group col-md-6">
							<label for="tahun">Nama Siswa</label>
							<input name="nm_siswa" class="form-control" value="<?php echo $siswa->nm_siswa?>" type="text" readonly="true" autofocus>
							</div>
							<div class="form-group col-md-6">
						   ...
						   foreach($list_kelamin as $value)
						   {
							...
							<input name="tempat" class="form-control" value="<?php echo $siswa->tempat?>"type="text" required >
							</div>
							<div class="form-group col-md-6">
							<label for="tgl_lahir">Tanggal Lahir</label>
							<input name="tgl_lahir" class="form-control" value="<?php echo $siswa->tgl_lahir?>" type="date" required >
							</div>
							</div>
							<div class="row">
							<div class="form-group col-md-6">
						   ...
						   foreach($list_negara as $value)
						   {
							...
							<input name="alamat" class="form-control" value="<?php echo $siswa->alamat?>"type="text" required >
							</div>
							<div class="form-group col-md-6">
							<label for="no_hp">NO HP</label>
							<input name="no_hp" class="form-control" value="<?php echo $siswa->no_hp?>"type="text" required >
							</div>
							 </div>
							 <div class="row">
							 <div class="form-group col-md-6">
						   ...
						   foreach($list_status_keluarga as $value)
						   {
							...
							<input name="anak_ke" class="form-control" value="<?php echo $siswa->anak_ke?>" type="number" required >
							</div>
							</div>
							 <div class="row">
							<div class="form-group col-md-6">
							<label for="alamat">Nama Ayah</label>
							<input name="nama_ayah" class="form-control" value="<?php echo $siswa->nama_ayah?>"type="text" required >
							</div>
							<div class="form-group col-md-6">
							<label for="no_hp">Nama Ibu</label>
							<input name="nama_ibu" class="form-control" value="<?php echo $siswa->nama_ibu?>"type="text" required >
							</div>
							 </div>
							 <div class="row">
							<div class="form-group col-md-6">
							<label for="alamat">Alamat Orang Tua</label>
							<input name="alamat_ayah" class="form-control" value="<?php echo $siswa->alamat_ayah?>" type="text" required >
							</div>
							<div class="form-group col-md-6">
							<label for="no_hp">No HP Orang Tua</label>
							<input name="no_hp_ayah" class="form-control" value="<?php echo $siswa->no_hp_ayah?>" type="text" required >
							</div>
							 </div>
							 <div class="row">
							<div class="form-group col-md-6">
							<label for="alamat">Pekerjaan Ayah</label>
                							<input name="pekerjaan_ayah" class="form-control" value="<?php echo $siswa->pekerjaan_ayah?>"type="text"  required >
							</div>
							<div class="form-group col-md-6">
							...
							<input name="nama_wali" class="form-control" value="<?php echo $siswa->nama_wali?>" type="text"  >
							</div>
							<div class="form-group col-md-6">
							<label for="no_hp">Pekerjaan Wali</label>
							<input name="pekerjaan_wali" class="form-control" value="<?php echo $siswa->pekerjaan_wali?>" type="text"  >
							</div>
							 </div>
							 		 <div class="row">
							<div class="form-group col-md-6">
							<label for="alamat">Alamat Wali</label>
							<input name="alamat_wali" class="form-control" value="<?php echo $siswa->alamat_wali?>" type="text" >
							</div>
							<div class="form-group col-md-6">
							<label for="no_hp">No HP Wali</label>
							<input name="no_hp_wali" class="form-control" value="<?php echo $siswa->no_hp_wali?>" type="text" >
							</div>
							 </div>
