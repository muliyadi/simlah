<div class="content" style="padding-top: 5px;padding-bottom:5px">
    ...
    <div class="card" style="padding-bottom: 5px;padding-right: 0px;padding-top: 5px">
        ...
        <div class="card-content">
            <form action="<?php echo base_url('xkurikulum/save_detail_kurikulum')?>" method="POST" role="form">
                    <input type="hidden" name="kd_kurikulum" value="<?php echo $kd_kurikulum?>">
                       ...
                       <button type="submit" class="btn btn-info btn-xs"><i class="material-icons">save </i>Simpan</button>
                         <a href="<?php echo base_url('xkurikulum/list_detail_kurikulum')?>" class="btn btn-warning btn-xs"><i class="material-icons">arrow_back </i>Kembali</a>
        </form>
        </div>
